...
export interface OriginalTokenBridgeHarnessInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface OriginalTokenBridgeHarness extends BaseContract {
  connect(runner?: ContractRunner | null): OriginalTokenBridgeHarness;
  waitForDeployment(): Promise<this>;

  interface: OriginalTokenBridgeHarnessInterface;

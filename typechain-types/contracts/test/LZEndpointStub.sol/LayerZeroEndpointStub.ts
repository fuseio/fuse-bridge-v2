...
export interface LayerZeroEndpointStubInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "estimateFees"
      | "forceResumeReceive"
...
export interface LayerZeroEndpointStub extends BaseContract {
  connect(runner?: ContractRunner | null): LayerZeroEndpointStub;
  waitForDeployment(): Promise<this>;

  interface: LayerZeroEndpointStubInterface;

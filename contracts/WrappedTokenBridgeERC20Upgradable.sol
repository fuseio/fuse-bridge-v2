...
contract WrappedTokenBridgeERC20Upgradable is WrappedTokenBridgeUpgradable {
    ...
    function bridge(address localToken, uint16 remoteChainId, uint amount, address to, bool unwrapWeth, LzLib.CallParams calldata callParams, bytes memory adapterParams) external payable override nonReentrant whenNotPaused {
        ...
        IBridgedERC20(localToken).burnFrom(msg.sender, amount);
